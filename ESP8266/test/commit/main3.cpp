...
int vol1 = 0, vol2 = 0, vol3 = 0, vol4 = 0;
  int vale1=0, vale2 = 0, vale3 = 0, vale4 = 0;
...
void handlePost()
{
  ...
  vale1 = doc["vale1"]; // Получение данных из JSON
  vale2 = doc["vale2"];
  vale3 = doc["vale3"];
  vale4 = doc["vale4"];
...
void handleGet()
{
  ...
  doc["vol3"] = vale3;
  doc["vol4"] = vale4;
  Serial.print("vol1: "); Serial.println(vale1);
  Serial.print("vol2: "); Serial.println(vale2);
  Serial.print("vol3: "); Serial.println(vale3);
  Serial.print("vol4: "); Serial.println(vale4);
  String jsonResponse;
